...
- [ ] if you are new with VS Code, see how to [[how-to/get-started-with-vscode]] and how to [[use-keyboard-shortcuts-for-editing]]
...
- [ ] to see how your notes are connected, execute the `Foam: Show Graph` command. See [[docs/features/graph-visualization]].
